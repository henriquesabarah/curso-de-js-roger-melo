...
*/
const allEpisodes = 'O nº de episódeos é: ' + episodes
...
let newName = nome[0].toUpperCase() + nome.slice(1, 7) + nome[7].toUpperCase() + nome.slice(8)
//console.log(newName)
...
- Exiba a "newName" no console;
*/
newName = `${nome[0].toUpperCase()}${nome.slice(1, 7)}${nome[7].toUpperCase()}${nome.slice(8)}`
console.log(newName)